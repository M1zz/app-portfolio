...
"""
Xcode 프로젝트 생성 스크립트
macOS SwiftUI 앱을 위한 .xcodeproj 파일 생성
"""
...
def create_project_structure():
    ...
    # UUIDs for all files and groups
    uuids = {
...
def main():
    ...
    # Create Resources directory and Assets.xcassets
    resources_dir = Path("PortfolioCEO/Resources")
...
"""
    ...
    accentcolor_dir = assets_dir / "AccentColor.colorset"
    accentcolor_dir.mkdir(exist_ok=True)
...
"""
    with open(accentcolor_dir / "Contents.json", 'w') as f:
        f.write(accentcolor_contents)

    # Create PortfolioCEO.entitlements
...
"""
    with open("PortfolioCEO/PortfolioCEO.entitlements", 'w') as f:
        f.write(entitlements_content)

    print("✅ Assets.xcassets 생성 완료")
    print("✅ PortfolioCEO.entitlements 생성 완료")
    print("\n🎉 Xcode 프로젝트 생성 완료!")
    print("\n다음 명령어로 Xcode에서 열 수 있습니다:")
    print("  open PortfolioCEO.xcodeproj")
