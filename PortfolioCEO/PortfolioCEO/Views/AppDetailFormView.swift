...
struct AppDetailFormView: View {
    ...
    var body: some View {
        ...
        .alert("저장 완료", isPresented: $showingSaveAlert) {
            ...
            Text("앱 상세 정보가 저장되었습니다.\n\n저장된 앱: \(savedCount)개\n경로: ~/Documents/workspace/code/app-portfolio/app-details/")
        }
    }
            ...
            HStack {
                ...
                VStack(alignment: .trailing, spacing: 4) {
                    ...
                    Button("경로 복사") {
                        ...
                        let appDetailsPath = documentsPath.appendingPathComponent("app-details")
                        NSPasteboard.general.clearContents()
                        NSPasteboard.general.setString(appDetailsPath.path, forType: .string)
                        print("📋 클립보드에 복사됨: \(appDetailsPath.path)")
                    }
